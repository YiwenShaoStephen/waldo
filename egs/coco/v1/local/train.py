...
parser.add_argument('--train-dir', default='data/download/train2017', type=str,
                    help='Directory of training images')
parser.add_argument('--val-dir', default='data/download/val2017', type=str,
                    help='Directory of validation images')
parser.add_argument('--train-ann', default='data/download/annotations/instances_train2017.json',
                    help='Path to training set annotations')
parser.add_argument('--val-ann', default='data/download/annotations/instances_val2017.json',
...
def main():
    ...
    valset = COCODataset(args.val_dir, args.val_ann, c_config,
                         args.train_image_size, class_nms=class_nms, limits=args.limits)
